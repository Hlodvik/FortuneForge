...
[ApiController]
[Route("api/cards/texas-holdem/bot-practice")]
public sealed class TexasHoldemBotPracticeController(IServiceProvider services) : ControllerBase
{
    private TexasHoldemBotPracticeService Service =>
        services.GetRequiredService<TexasHoldemBotPracticeService>();
