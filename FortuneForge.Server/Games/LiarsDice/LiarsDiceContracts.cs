...
public sealed record LiarsDiceOutcomeResponse(string ChallengerId, string BidderId, string LoserId, int Quantity, int Face, int MatchingDice, string CallType);
