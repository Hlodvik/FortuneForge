    ...
    private static readonly IReadOnlyDictionary<string, SlotSpecialRoundProfile> Profiles =
        new Dictionary<string, SlotSpecialRoundProfile>(StringComparer.Ordinal)
        {
            ...
            [PiratesFortuneGameId] = new(
                ...
                0.32m),
            [RoyalDrawGameId] = new(RoyalDrawGameId, 3, 6, 24, 7, true, true, true, null, "rows-rand"),
            [SamuraiFortuneGameId] = new(SamuraiFortuneGameId, 4, 6, 26, 7, true, false, false, null, "sync-paw"),
            [RobotRevolutionGameId] = new(RobotRevolutionGameId, 3, 7, 24, 8, false, false, false, "rows"),
            [PhantomManorGameId] = new(PhantomManorGameId, 3, 5, 18, 9, false, false, false, "paw"),
            [OceanOdysseyGameId] = new(OceanOdysseyGameId, 4, 6, 28, 6, true, true, false, null, "sync-rand"),
            [DragonHoardGameId] = new(DragonHoardGameId, 3, 6, 30, 7, true, false, false, null, "rows-paw"),
            [JungleJackpotGameId] = new(JungleJackpotGameId, 3, 6, 22, 8, true, false, false, null, "sync-rows-paw"),
